...
# Speed-up: fuzzy match each distinct buyer-name problem once, then expand the
...
# group's match onto every original buyer row, then recombine with the pre-fuzzy
