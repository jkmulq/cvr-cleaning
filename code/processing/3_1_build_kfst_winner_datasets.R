...
# entity-identity / per-CVR / per-winner columns (incl. KFST per-winner award_date / consortium
# members / field-CVR candidates, which stay row-level) -- see its definition in functions.R. Replaces
# the hand-kept allow-list that silently dropped notice-level fields from the non-production slices.
