...
#    dumps dropped), NA-filling the KFST-only columns absent from OpenTender so the two winner stacks
#    share one schema. The cvr_list_* agreement intermediates are dropped here (not in `target`).
