...
# Draft speed-up: fuzzy match each distinct winner-name problem once.
...
# Expand distinct-name fuzzy matches back to every original winner row.
...
# 7 Save
saveRDS(winner_data,
        file.path(clean_data_dir, "clean_winner_data_kfst_name_matched_distinct_draft.rds"))
saveRDS(manual_name_review, 
        file.path(clean_data_dir, "manual_name_review_kfst_distinct_draft.rds"))
